...
function AllChats() {
    ...
    const sendMessage = async() => {
        axios.post('http://134.0.118.29:8000/api/send-telegram-message/', {
    ...
    const createChatMessage = async () => {
        const createMsgReq = 'http://134.0.118.29:8000/api/messages/create/';
    ...
    useEffect(() => {
        ...
        const getUsers = async () => {
            let usersarr = []
            const apiUrl = 'http://134.0.118.29:8000/api/users/';
        ...
        const defaultChatMessages = async() => {
            const apiUrl = `http://134.0.118.29:8000/api/messages/?chat_id=${currentChatId}`;
            axios.get(apiUrl)
              .then(response => {
